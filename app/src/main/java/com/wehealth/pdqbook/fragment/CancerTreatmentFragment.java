 ...
 * {@link CancerTreatmentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CancerTreatmentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CancerTreatmentFragment extends BaseFragment {
    private static final String TAG = CancerTreatmentFragment.class.getSimpleName();
    ...
    public CancerTreatmentFragment() {
     ...
     * @return A new instance of fragment CancerTreatmentFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CancerTreatmentFragment newInstance(String url) {
        CancerTreatmentFragment fragment = new CancerTreatmentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mView == null) {
            mView = inflater.inflate(R.layout.fragment_cancer_treatment, container, false);
            mWebView = (WebView) mView.findViewById(R.id.webpager_treatment);
            CircleProgressBar bar1 = (CircleProgressBar) mView.findViewById(R.id.webpage_treatment_progressbar);
